...
/*$(document).ready(function(){
     ...
     $('.mae-maria').text('sou filha legitima e direta de mae maria');  
     $('.mae-maria span').text('sou o span filho de mae maria?');  
     $('.mae-maria > span').text('sou a filha leg[itima');  
...
$(document).ready(function(){
    ...
    $('p').css({ margin:'0', color: '#582365'});
    $('.mae-maria').css({margin: '0, 15px, 25px', backgroundColor: '#94cbe0'})
    $('.mae-maria h2').text('sou filha legitima e direta de mãe maria')
    $('.mae-maria span').text('sou o span filho de mãe maria?');
    $('.mae-maria > span').text('sou a filha legitima de mãe maria!!!');
